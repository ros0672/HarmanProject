...
public class Task {
    ...
    public String getMatrixLeft() { return matrixLeft; }

    public void setMatrixLeft(String matrixLeft) {
        this.matrixLeft = matrixLeft;
    }

    public Integer getMatrixLeftRowSize() { return matrixLeftRowSize; }

    public void setMatrixLeftRowSize(Integer matrixLeftRowSize) {
        this.matrixLeftRowSize = matrixLeftRowSize;
    }
    public Integer getMatrixLeftColSize() { return matrixLeftColSize; }
    ...
    public Integer getMatrixRightRowSize() { return matrixRightRowSize; }

    public void setMatrixRightRowSize(Integer matrixRightRowSize) {
        this.matrixRightRowSize = matrixRightRowSize;
    }
    public Integer getMatrixRightColSize() { return matrixRightColSize; }
